...
<div class="container-fluid footer">
	...
	<div class="row footer-bottom">
		<div class="col-md-12">
			<span class="copy">Copyright &copy; <?php echo date('Y');?> Yanmu News | Repost by <a style="color: red;" href='https://sgfproduction.com/' title='Sgfproduction.com' target='_blank'>Sgfproduction.com</a>
			</span>
		</div>
	</div>
</div>
